...
import static app2048.Utilities.shuffleArray;
 ...
 class NodeOper {
    ...
    synchronized GridPane addRndNode(GridPane board) {
    ...
    synchronized  GridPane removeNodeLeftRight(GridPane board, String direction) {
        Node lastNode0 = null;
        ...
        if (direction.equals("left"))
            ...
            sorted = new SortedList<>(board.getChildren(), comparator);
        else sorted = new SortedList<>(board.getChildren(), comparator.reversed());


        for (Node node : sorted) {
            //   System.out.println(((Label) node).getText());

            if ((int) node.getBoundsInParent().getMinY() == 0) if (lastNode0 == null) {
                lastNode0 = node;
            ...
            if ((int) node.getBoundsInParent().getMinY() == 100) if (lastNode100 == null) {
                lastNode100 = node;
            ...
            if ((int) node.getBoundsInParent().getMinY() == 200) if (lastNode200 == null) {
                lastNode200 = node;
            ...
            if ((int) node.getBoundsInParent().getMinY() == 300) if (lastNode300 == null) {
                lastNode300 = node;
        ...
        if (!(removeList.isEmpty())) board.getChildren().removeAll(removeList);
        return board;
    }

    synchronized  GridPane removeNodeUpDown(GridPane board, String direction) {
        Node lastNode0 = null;
        Node lastNode100 = null;
        Node lastNode200 = null;
        Node lastNode300 = null;
        ...
        for (Node node : sorted) {
            ...
            if ((int) node.getBoundsInParent().getMinX() == 0) if (lastNode0 == null) {
                lastNode0 = node;
            } else if (((Label) node).getText().equals(((Label) lastNode0).getText())) {
                int textNumber = Integer.parseInt(((Label) lastNode0).getText()) * 2;
                ((Label) lastNode0).setText(String.valueOf(textNumber));
            ...
            if ((int) node.getBoundsInParent().getMinX() == 100) if (lastNode100 == null) {
                lastNode100 = node;
            } else if (((Label) node).getText().equals(((Label) lastNode100).getText())) {
                int textNumber = Integer.parseInt(((Label) lastNode100).getText()) * 2;
                ((Label) lastNode100).setText(String.valueOf(textNumber));
            ...
            if ((int) node.getBoundsInParent().getMinX() == 200) if (lastNode200 == null) {
                lastNode200 = node;
            } else if (((Label) node).getText().equals(((Label) lastNode200).getText())) {
                int textNumber = Integer.parseInt(((Label) lastNode200).getText()) * 2;
                ((Label) lastNode200).setText(String.valueOf(textNumber));
            ...
            if ((int) node.getBoundsInParent().getMinX() == 300) if (lastNode300 == null) {
                lastNode300 = node;
            } else if (((Label) node).getText().equals(((Label) lastNode300).getText())) {
                int textNumber = Integer.parseInt(((Label) lastNode300).getText()) * 2;
                ((Label) lastNode300).setText(String.valueOf(textNumber));
